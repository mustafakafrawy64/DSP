...
Contains functions for DFT, IDFT, and related frequency-domain operations.
"""
...
def dft(y_values, Fs):
    ...
    Args:
        y_values (list or np.array): The time-domain signal samples.
...
def idft(complex_components):
    ...
    Args:
        complex_components (np.array): The complex frequency-domain components.
...
def test_reconstructed_signal(signal_object, test_file_path):
    ...
    Args:
        signal_object (Signal): The Signal object to test.
        test_file_path (str): The path to the expected signal file.
    """
